...
def build_graph(site_dropdown):
    ...
    if site_dropdown == 'ALL':
        piechart = px.pie(filtered_df, names='Launch Site', values='class' ,title='Total Launches for All Sites')
        return piechart
    else:
...
def update_graph(site_dropdown, payload_slider):
    ...
    if site_dropdown == 'ALL':
        ...
        specific_df=spacex_df.loc[spacex_df['Launch Site'] == site_dropdown]
        scatterplot = px.scatter(data_frame=specific_df, x="Payload Mass (kg)", y="class", 
        color="Booster Version Category")
        return scatterplot
